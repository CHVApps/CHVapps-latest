    ...
    <nav className={`navbar ${showNavbar ? 'visible' : 'hidden'}`} ref={navRef}>
      <div className="navbar-container">
        ...
        <div className={`nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          >
            <button className="nav-dropdown-btn" onClick={(e) => e.preventDefault()}>
              Get Courses
            </button>
            {coursesOpen && (
              <div className="nav-dropdown-menu">
                <Link to="/basics" onClick={() => handleLinkClick('/basics')}>
                  Basics
                </Link>
                <Link to="/advanced" onClick={() => handleLinkClick('/advanced')}>
                  Advanced
                </Link>
              </div>
            )}
        ...
        <div className="right-section">
          <div className="right-inner">
            <button className="get-started-button" onClick={() => handleLinkClick('/contact')}>
              Get Started
            </button>
